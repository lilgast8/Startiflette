module.exports = {
	...
	src : {
		...
		jsApp				: 'www/src/js/app/',
		jsAppFiles			: 'www/src/js/app/**/*.js',
		jsJsFilesFile		: 'www/src/js/js-files.json',
		jsAppDesktop		: 'www/src/js/app/desktop/',
		jsAppDesktopFiles	: 'www/src/js/app/desktop/**/*.js',
		jsAppMobile			: 'www/src/js/app/mobile/',
		jsAppMobileFiles	: 'www/src/js/app/mobile/**/*.js',
		jsShared			: 'www/src/js/app/shared/',
		jsSharedFiles		: 'www/src/js/shared/**/*.js',
