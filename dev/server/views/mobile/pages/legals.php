...
<section id="page" class="legals">
	...
	<p>
		Le site <a href="<?php echo Path::SITE_URL; ?>" target="_blank"><?php echo Path::SITE_URL; ?></a> que vous consultez actuellement est la propriété de : <br />
		<br />
		NOM SOCIÉTÉ <br />
		ADRESSE <br />
		CP VILLE <br />
