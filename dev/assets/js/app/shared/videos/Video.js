...
Video.prototype				= Object.create( AbstractView.prototype );
...
var _loadStart = function() {
	if ( this.isFireLoadStart && !this.isLoadStart && Device.IS_DESKTOP ) {
...
var _canPlay = function() {
	if ( this.isFireCanPlay && !this.isCanPlay && Device.IS_DESKTOP ) {
		this.isCanPlay	= true;
