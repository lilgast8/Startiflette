...
<section id="page-content" class="legals">
	...
	<p>
		Le site <a href="<?php echo Path::$URL->base; ?>" target="_blank"><?php echo Path::$URL->base; ?></a> que vous consultez actuellement est la propriété de : <br />
		<br />
		NOM SOCIÉTÉ <br />
		ADRESSE <br />
		CP VILLE <br />
