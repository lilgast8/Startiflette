	...
	<link rel="apple-touch-icon" sizes="180x180" href="<?php echo WEB_ROOT; ?>img/logos/favicons/apple-touch-icon-180x180.png">
	<link rel="shortcut icon" href="<?php echo WEB_ROOT; ?>img/logos/favicons/favicon.ico">
	<link rel="icon" type="image/png" href="<?php echo WEB_ROOT; ?>img/logos/favicons/favicon-192x192.png" sizes="192x192">
	...
	<meta name="msapplication-config" content="<?php echo WEB_ROOT; ?>img/logos/favicons/browserconfig.xml">
